      ...
      <div className={classes.root}>
        ...
        <Container>
          ...
          <Box my={2}>
            <Card>
              <CardActions disableSpacing>
                <Typography variant="h3" >Legal Injustices:</Typography>
                <IconButton
          ...
          <Box my={2}>
            <Card>
              <CardActions disableSpacing>
                <Typography variant="h3" >The Most Recent Events:</Typography>
                <IconButton
                  className={clsx(classes.expand, {
